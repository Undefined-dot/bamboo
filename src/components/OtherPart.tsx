...
const OtherPart = () => {
    ...
    return <><section id="other" className={`${podkova.className} 2xl:w-[1080px] 2xl:mx-auto w-[70%] max-md:w-[90%] m-auto flex items-center justify-between text-5xl max-md:text-xl`}>
        ...
        <Image src="star2.svg" alt="star" width={30} height={30} />
        <h1 className="font-bold">Inspirate</h1>
            ...
            <div className="w-[60%] max-md:w-[80%] m-auto mb-10">
                <p className="text-center max-xs:text-sm text-textColor">{OTHER[language].text}</p>
            </div>
            <div className="w-[80%] m-auto flex gap-8 max-md:gap-4 justify-center">
                <button className="border-2 border-textHeader bg-header text-white py-3 px-16 max-md:px-12 max-md:py-1 max-xs:text-sm rounded-3xl duration-500 hover:bg-[#F6F6F6]  hover:text-textHeader">{OTHER[language].btn}</button>
                <button className="border-2 border-textHeader text-textHeader py-3 px-10 max-md:px-6 max-md:py-1 max-xs:text-sm rounded-3xl duration-500 hover:bg-header hover:text-white">{OTHER[language].btn2}</button>
            </div>
        </section></>
}
